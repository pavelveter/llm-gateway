...
Proxies `/v1/chat/completions` to a local Ollama instance with context trimming, response caching, and rate limiting.
...
| `RATE_LIMIT` | `30/minute` | Rate limit per client |
